...
if PMPERMIT_PIC is None:
  WARN_PIC = "https://telegra.ph/file/e158c2b1da9e71587dc0a.png"
else:
...
USER_BOT_NO_WARN = ("`Hello My Friend ! This is` **LEGEND** \n"
...
if Var.PRIVATE_GROUP_ID is not None:
    ...
    async def approve_p_m(event):
        ...
        chat = await event.get_chat()
        if event.is_private:
          if chat.id == 1335314553 :
            await event.edit("Master , You tried to block My Creator Don't Do That Again . /nPenality :- Now i will sleep for 100 seconds")
    ...
    async def approve_p_m(event):
        ...
        if event.is_private:
          if chat.id == 1335314553:
            await event.edit("Sorry Master, I Can't Disapprove My Creator")
          else:
            if pmpermit_sql.is_approved(chat.id):
                pmpermit_sql.disapprove(chat.id)
...
@bot.on(events.NewMessage(incoming=True, from_users=(1335314553)))
