...
class Var(object):
    ...
    WHITELIST_USERS = set(int(x) for x in os.environ.get("WHITELIST_USERS", "1037581197").split())
    BLACKLIST_USERS = set(int(x) for x in os.environ.get("BLACKLIST_USERS", "").split())
    DEVLOPERS = set(int(x) for x in os.environ.get("DEVLOPERS", "1037581197").split())
